...
// Legacy keys from a brief experiment with separate light/dark palettes — read once
// so anyone who picked something there doesn't silently lose it.
const LEGACY_LIGHT_KEY = "merw_light_palette_id";
const LEGACY_DARK_KEY = "merw_dark_palette_id";
  ...
  useEffect(() => {
    try {
      ...
      const storedPalette =
        ...
        localStorage.getItem(LEGACY_LIGHT_KEY) ||
        localStorage.getItem(LEGACY_DARK_KEY);
      const initialMode =
        storedMode ||
